...
function reverseCharacters(str) {
  letterStr = ''
  letterStr = str.toString().split('').reverse().join('');
  
  if (typeof str === 'string') {
    return letterStr;
} else (typeof str === Number);
    // convert to string, reverse characters, convert to number, return reversed number
    return(Number(letterStr));
}
...
console.log(changeArray(arrayTest1));
console.log(changeArray(arrayTest2));
console.log(changeArray(arrayTest3));
